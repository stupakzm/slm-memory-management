#!/usr/bin/env python3
"""Phase 1 index: flat fixed-size chunks, dense embeddings only, sqlite-vec.
...
from smm.chunk import CHUNK_CHARS, OVERLAP_CHARS, chunk_corpus, to_dict  # noqa: E402
...
def main() -> int:
    ...
    store.set_meta(
        ...
        prefix=not args.no_prefix, corpus=args.corpus, phase="1-flat-dense",
    )
